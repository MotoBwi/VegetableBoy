...
CREATE TABLE `DeliveryPerson` (
    ...
    UNIQUE INDEX `DeliveryPerson_phone_key`(`phone`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Product` (
    ...
    `price250` INTEGER NOT NULL DEFAULT 0,
    `price500` INTEGER NOT NULL DEFAULT 0,
    `price1kg` INTEGER NOT NULL DEFAULT 0,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,
...
-- AddForeignKey
ALTER TABLE `DeliveryPerson` ADD CONSTRAINT `DeliveryPerson_zoneId_fkey` FOREIGN KEY (`zoneId`) REFERENCES `Zone`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
